...
try {
    ...
    $possiblePaths = [
        '/var/www/auth/jwt-core.php',  // Production Render path
        __DIR__ . '/auth/jwt-core.php', // Local/Repository path
    ];
    ...
    $results['details'][] = "Successfully read JWT core file contents";
    ...
    $results['message'] = "JWT function fix completed successfully.";
