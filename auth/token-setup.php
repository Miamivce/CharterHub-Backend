 ...
 * 
 * This script creates all the necessary tables for the JWT authentication system.
 */
...
$tables = [
    // JWT tokens table (main table for tokens)
...
$response = ['success' => true, 'created_tables' => []];
